...
{
    /// <inheritdoc />
    public partial class Phase1_DomainRefactor : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntidadeId = table.Column<string>(type: "character varying(36)", maxLength: 36, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethods_CompanyId_Name",
                table: "PaymentMethods",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Auditorias_CompanyId_DataHora",
                table: "Auditorias",
                columns: new[] { "CompanyId", "DataHora" });

            migrationBuilder.CreateIndex(
                name: "IX_Clientes_CompanyId_Documento",
                table: "Clientes",
                columns: new[] { "CompanyId", "Documento" },
                unique: true);
